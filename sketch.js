...
function setup() {
  ...
  block23 = new Block(650,100,30,40);
  block24 = new Block(680,100,30,40);
  block25 = new Block(710,100,30,40);
  block26 = new Block(740,100,30,40);

  block27 = new Block(680,50,30,40);
  block28 = new Block(710,50,30,40);

  block29 = new Block(695,10,30,40);
}
function draw() {
  background(56,44,44); 
